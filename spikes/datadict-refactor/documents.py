...
from utils import py_datetime_to_js_datestring, js_datestring_to_py_datetime, utcnow, is_string
...
class DataDictDcoument(DocumentBase):
    ...
    def __init__(self, id=None, name=None, data_type=None, description=None, constraints=None):
        '''Create a new CouchDB document that represents a DataDictType'''
        DocumentBase.__init__(self, id, 'DataDictionary')

        assert name is None or is_string(name)
        assert data_type is None or is_string(data_type)
